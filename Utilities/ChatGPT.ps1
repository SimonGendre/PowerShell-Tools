...
# Show startup text
Clear-Host
Write-Host "######################`n# ChatGPT Powershell #`n######################`n`nEnter your prompt to continue. (type 'exit' to quit or 'reset' to start a new chat)" -ForegroundColor DarkGreen
...
while ($true) {
    ...
    # Show response
    Write-Host "AI: $aiResponse" -ForegroundColor Magenta
